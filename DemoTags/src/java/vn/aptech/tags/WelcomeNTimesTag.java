 ...
 * Click nbfs://nbhost/SystemFileSystem/Templates/JSP_Servlet/BodyTagHandler.java to edit this template
 */
package vn.aptech.tags;
 ...
 */
public class WelcomeNTimesTag extends BodyTagSupport {
    ...
    public int doAfterBody() throws JspException {
        try {
            ...
            String bContent = bodyCont.getString();// doc noi dung body
            // xuat n chuoi
            for (int i = 0; i < n; i++) {
                out.println("<div>"+bContent+"</div>");
            }
//            writeTagBodyContent(out, bodyCont);
    ...
    private void handleBodyContentException(Exception ex) throws JspException {
        ...
        throw new JspException("Error in WelcomeNTimesTag tag", ex);
    }
